...
from gaussians import Gaussians, construct_covariance_matrix
import torch
...
class GaussianAdapter(torch.nn.Module):
    ...
    def forward(
        ...
        ray_o, ray_d = get_camera_rays(pixel_centers, extrinsics, intrinsics)
        ...
        # [TODO: need to rotate SH] sh = rotate_sh(sh, c2w) 
